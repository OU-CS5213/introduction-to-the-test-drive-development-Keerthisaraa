...
##Commit Statements
* Created the method removeBiggerThan(int threshold) which fails the test
* Made chenges to the method testFillAndExpandNegative() to pass the test
* Created the method stepMultiplier() which fails the test
